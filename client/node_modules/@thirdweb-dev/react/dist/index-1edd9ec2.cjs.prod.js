  ...
  const wagmiProps = React.useMemo(() => {
    ...
    const _rpcUrlMap = {
      ...mergedChains.reduce((acc, c) => {
        try {
          acc[c.chainId] = chains.getChainRPC(c, {
            thirdwebApiKey,
            alchemyApiKey,
            infuraApiKey
          });
...
const ThirdwebSDKProviderWagmiWrapper = _ref3 => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(evm.ThirdwebSDKProvider, {
    signer: signer.data,
    ...props,
    children: children
  });
...
function useAccount() {
  ...
  invariant__default["default"](wagmiContext, `useAccount() can only be used inside <ThirdwebProvider />. If you are using <ThirdwebSDKProvider /> you will have to use your own account logic.`);
...
const Button = _ref => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Btn, {
    ...
    children: [isLoading ? /*#__PURE__*/jsxRuntime.jsx(Spinner, {
      ...
      children: [leftElement, /*#__PURE__*/jsxRuntime.jsx("span", {
        style: {
          width: "100%",
          display: "flex",
...
const SupportedNetworkSelect = _ref => {
  ...
  const config = evm.useThirdwebConfigContext();
  const {
    mainnets,
    testnets
  } = React.useMemo(() => {
...
const chainIdToCurrencyMap = {
  ...
  [sdk.ChainId.Hardhat]: "ethereum",
  [sdk.ChainId.Localhost]: "ethereum"
};
