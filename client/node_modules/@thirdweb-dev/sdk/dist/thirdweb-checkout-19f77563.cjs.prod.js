...
var IRouterAbi = require('@thirdweb-dev/contracts-js/dist/abis/IRouter.json');
...
var RouterABI = require('@thirdweb-dev/contracts-js/dist/abis/Router.json');
...
var IRouterAbi__default = /*#__PURE__*/_interopDefault(IRouterAbi);
...
var RouterABI__default = /*#__PURE__*/_interopDefault(RouterABI);
...
const FEATURE_PLUGIN_ROUTER = {
  ...
  abis: [IRouterAbi__default["default"]],
  features: {}
};
...
class TransactionTask {
  ...
  constructor(taskArgs) {
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    QueryParams._defineProperty(this, "functionName", void 0);
...
async function getCompositePluginABI(address, abi, provider, options, storage) {
  ...
  try {
    ...
    if (isPluginRouter) {
      const contract = new ContractWrapper(provider, address, RouterABI__default["default"], options);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-drop-8cc358ad.cjs.prod.js'); }), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-65badb7a.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./marketplace-817b48e4.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceV3Initializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./marketplacev3-7ad7824a.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./multiwrap-d95c3aef.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-collection-dc7f1c7a.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-drop-e7ac085e.cjs.prod.js'); }), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./pack-64850fd0.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./signature-drop-d81b56b2.cjs.prod.js'); }), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./split-3fea6070.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-drop-ae94ea4c.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-80ec6f7e.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./vote-dcf2f690.cjs.prod.js'); }), provider.getNetwork()]);
...
class SmartContract {
  ...
  constructor(network, address, abi, storage) {
    ...
    QueryParams._defineProperty(this, "abi", void 0);
    QueryParams._defineProperty(this, "metadata", void 0);
    QueryParams._defineProperty(this, "appURI", void 0);
    QueryParams._defineProperty(this, "_chainId", void 0);
    this._chainId = chainId;
    this.storage = storage;
    this.contractWrapper = contractWrapper;
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  constructor(network) {
    ...
    if (typeof network !== "string" && typeof network !== "number" && !ethers.ethers.Signer.isSigner(network) && !ethers.ethers.providers.Provider.isProvider(network)) {
      options = {
        ...options,
    ...
    this.deployer = new ContractDeployer(network, options, storage$1);
