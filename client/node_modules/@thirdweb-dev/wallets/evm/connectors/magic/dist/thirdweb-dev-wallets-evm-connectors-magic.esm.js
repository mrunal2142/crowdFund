...
import { Connector, normalizeChainId, UserRejectedRequestError, ChainNotConfiguredError } from '@wagmi/core';
import { providers } from 'ethers';
import { getAddress } from 'ethers/lib/utils';
import { OAuthExtension } from '@magic-ext/oauth';
import { getAddress as getAddress$1 } from 'ethers/lib/utils.js';
...
class MagicAuthConnector extends MagicConnector {
  constructor(config) {
    ...
    _defineProperty(this, "enableSMSLogin", void 0);
    _defineProperty(this, "enableEmailLogin", void 0);
    _defineProperty(this, "oauthProviders", void 0);
    ...
    try {
      ...
      if (isAuthenticated) {
        return {
          ...
          account: getAddress$1(await this.getAccount())
        };
      }
...
export { MagicAuthConnector, MagicConnectConnector };
