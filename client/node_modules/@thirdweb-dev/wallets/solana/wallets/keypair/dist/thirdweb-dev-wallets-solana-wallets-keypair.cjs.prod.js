...
class KeypairSigner {
  constructor(keypair) {
    classPrivateFieldGet._classPrivateFieldInitSpec(this, _keypair, {
      writable: true,
      value: void 0
    });
    defineProperty._defineProperty(this, "publicKey", void 0);
    classPrivateFieldGet._classPrivateFieldSet(this, _keypair, keypair);
    this.publicKey = keypair.publicKey;
  }
  async signMessage(message) {
    return ed25519__namespace.sync.sign(message, classPrivateFieldGet._classPrivateFieldGet(this, _keypair).secretKey.slice(0, 32));
  }
}
