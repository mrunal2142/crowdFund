...
import { UserWallet, ListingType, fetchCurrencyMetadata, convertToReadableQuantity, fetchCurrencyValue, ThirdwebSDK as ThirdwebSDK$1 } from '@thirdweb-dev/sdk';
...
function resolveChainIdFromNetwork(network) {
...
const WrappedThirdwebSDKProvider = _ref => {
  ...
  const sdk = useMemo(() => {
    ...
    return sdk_;
  }, [activeChainId, alchemyApiKey, infuraApiKey, supportedChains, sdkOptions, signer, storageInterface, thirdwebApiKey]);
...
function useSDKChainId() {
  const sdk = useSDK();
  return sdk?.getProvider()?._network?.chainId;
}
...
export { useValidEnglishAuctions as $, useTotalCount as A, useTotalCirculatingSupply as B, useOwnedNFTs as C, useNFTBalance as D, useMintNFT as E, useMintNFTSupply as F, useTransferNFT as G, useAirdropNFT as H, useBurnNFT as I, useUnclaimedNFTs as J, useClaimedNFTs as K, useUnclaimedNFTSupply as L, useClaimedNFTSupply as M, useBatchesToReveal as N, useClaimNFT as O, useLazyMint as P, useDelayedRevealLazyMint as Q, useRevealLazyMint as R, useListing as S, ThirdwebSDKProvider as T, useDirectListing as U, useEnglishAuction as V, useListings as W, useDirectListings as X, useValidDirectListings as Y, useEnglishAuctions as Z, __DEV__ as _, useSDKChainId as a, useThirdwebAuthContext as a$, useListingsCount as a0, useDirectListingsCount as a1, useEnglishAuctionsCount as a2, useActiveListings as a3, useWinningBid as a4, useEnglishAuctionWinningBid as a5, useAuctionWinner as a6, useBidBuffer as a7, useMinimumNextBid as a8, useCreateDirectListing as a9, useUpdatePrimarySaleRecipient as aA, useRoyaltySettings as aB, useUpdateRoyaltySettings as aC, usePlatformFees as aD, useUpdatePlatformFees as aE, useMetadata as aF, useUpdateMetadata as aG, useAllRoleMembers as aH, useRoleMembers as aI, useIsAddressRole as aJ, useSetAllRoleMembers as aK, useGrantRole as aL, useRevokeRole as aM, useAuth as aN, useLogin as aO, useLogout as aP, useUser as aQ, useStorage as aR, useStorageUpload as aS, useSigner as aT, useReadonlySDK as aU, useNetworkMismatch as aV, useBalance as aW, useConnectedWallet as aX, useAddress as aY, useChainId as aZ, ThirdwebAuthProvider as a_, useCreateAuctionListing as aa, useCancelListing as ab, useCancelDirectListing as ac, useCancelEnglishAuction as ad, useMakeBid as ae, useMakeOffer as af, useAcceptDirectListingOffer as ag, useExecuteAuctionSale as ah, useOffers as ai, useBuyNow as aj, useTokenSupply as ak, useTokenBalance as al, useTokenDecimals as am, useMintToken as an, useClaimToken as ao, useTransferToken as ap, useTransferBatchToken as aq, useBurnToken as ar, useActiveClaimCondition as as, useClaimerProofs as at, useClaimConditions as au, useClaimIneligibilityReasons as av, useActiveClaimConditionForWallet as aw, useSetClaimConditions as ax, useResetClaimConditions as ay, usePrimarySaleRecipient as az, useEditionDrop as b, ThirdwebConfigProvider as b0, useThirdwebConfigContext as b1, ThirdwebConnectedWalletProvider as b2, useThirdwebConnectedWalletContext as b3, getErcs as b4, getErc1155 as b5, getErc721 as b6, getErc20 as b7, useEdition as c, useNFTDrop as d, useMarketplace as e, useNFTCollection as f, usePack as g, useToken as h, useTokenDrop as i, useVote as j, useSplit as k, useMultiwrap as l, useSignatureDrop as m, useContractType as n, contractType as o, useCompilerMetadata as p, compilerMetadata as q, useContract as r, useContractMetadata as s, useContractMetadataUpdate as t, useSDK as u, useContractEvents as v, useContractRead as w, useContractWrite as x, useNFT as y, useNFTs as z };
