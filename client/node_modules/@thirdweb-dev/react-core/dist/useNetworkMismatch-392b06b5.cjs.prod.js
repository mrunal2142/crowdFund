...
var requiredParam = require('./required-param-3dc80806.cjs.prod.js');
...
function resolveChainIdFromNetwork(network) {
  ...
  if (typeof network === "number") {
    if (chains$1.find(c => c.chainId === network)) {
      chainId = network;
    }
  } else if (typeof network === "string") {
    const chain = chains$1.find(c => c.slug === network);
    if (chain) {
...
const WrappedThirdwebSDKProvider = _ref => {
  ...
  const sdk = react.useMemo(() => {
    ...
    if (signer) {
      // sdk from signer
      sdk_ = new evm$1.ThirdwebSDK(signer, {
        ...mergedOptions,
        infuraApiKey,
        alchemyApiKey,
        thirdwebApiKey
